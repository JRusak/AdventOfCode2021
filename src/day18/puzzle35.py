...
def magnitude_of_final_sum(data):
    pairs = process_data(data)
    pair = pairs[0]

    for p in pairs[1:]:
        pair = pair.add_pair(p)

    return pair.get_magnitude()
...
if __name__ == '__main__':
    ...
    print(magnitude_of_final_sum(test_data))
    print(magnitude_of_final_sum(actual_data))
